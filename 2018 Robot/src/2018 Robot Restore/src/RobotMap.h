...
constexpr int UPPER_HALL_EFFECT_SENSOR_PORT = 6;
constexpr int LOWER_HALL_EFFECT_SENSOR_PORT = 5;
constexpr int UPPER_GANTRY_PHOTO_SENSOR_PORT = 4;
constexpr int LOWER_GANTRY_PHOTO_SENSOR_PORT = 3;

constexpr int LEFT_DRIVE_ENCODER_PORT_A = 0;
constexpr int LEFT_DRIVE_ENCODER_PORT_B = 0;
constexpr int RIGHT_DRIVE_ENCODER_PORT_A = 0;
constexpr int RIGHT_DRIVE_ENCODER_PORT_B = 0;
